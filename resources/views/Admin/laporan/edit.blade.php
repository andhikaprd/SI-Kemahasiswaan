            ...
            <form action="{{ route('admin.laporan.update', $laporan->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="periode" name="periode" value="{{ old('periode', $laporan->periode) }}" placeholder="Contoh: Januari - Juli 2024" required>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4">{{ old('deskripsi', $laporan->deskripsi) }}</textarea>
                </div>
